...
hive -hiveconf current_day=${current_day} -hiveconf yesterday=${yesterday} -hiveconf current_month=${current_month} -hiveconf current_year=${current_year} -f /appl/rts/reports/ti/liquidity_daily_table_create_bk.sql
ret_code=$?
