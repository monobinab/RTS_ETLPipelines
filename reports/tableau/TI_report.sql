...
(
    ...
    WHERE contactdate BETWEEN DATE'2015-10-18' AND DATE'2015-10-24'
...
(
		...
		WHERE day_DT BETWEEN DATE'2015-10-18' AND DATE'2015-10-24'
...
UNION		
		...
		WHERE TRS_DT BETWEEN DATE'2015-10-18' AND DATE'2015-10-24'
		AND lyl_id_no IS NOT NULL
		AND lyl_id_no>9
...
(
    ...
    ON a.OfferInstanceVersionID=b.OfferInstanceVersionID
    WHERE a.contactdate BETWEEN DATE'2015-10-18' AND DATE'2015-10-24'
    AND a.TouchpointChannelAbbr IN ('KPOS','NPOS','TPOS','SHPSRS')
...
WHERE a.RedemptionDate BETWEEN DATE'2015-10-18' AND DATE'2015-10-24'+7
AND IssuanceDate BETWEEN DATE'2015-10-18' AND DATE'2015-10-24'
AND a.TouchpointChannelAbbr IN ('KPOS','NPOS','TPOS','SHPSRS')
...
LEFT JOIN (SELECT loyaltyid_iss,
			...
			WHERE IssuanceDate BETWEEN DATE'2015-10-18' AND DATE'2015-10-24'
			GROUP BY 1,2,3) d
...
(
    ...
    FROM shc_work_tbls.ms_TI_RTS_rdmpt_IT
    WHERE RedemptionDate BETWEEN DATE'2015-10-18' AND DATE'2015-10-24'+7
    GROUP BY 1
) AS rd
