...
input_file='/staging/response_cnt/000000_0'
...
for line in input_file_handle:
    if line is not None:
        ...
        if hrs < 24 :
            goodResultFound = False;
            print("will send email because hours is less than expected")
        elif member_cnt < 1000000 :
	    goodResultFound = False;
	    print("will send email because member count is less than expected")
	else:
...
if goodResultFound:
    ...
    # send failure email
    message = """Subject: There may be a problem with yesterday's API_RESPONSE_LOG hive table load\n
