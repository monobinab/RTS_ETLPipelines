...
pig -param current_year=${current_year} -param current_month=${current_month} -f ${script_dir}/${script_file} 2>&1 > /home/auto/msaha/rts/api/final/logs/pig_encrypt_id.log
ret_code=$?
case ${ret_code} in
